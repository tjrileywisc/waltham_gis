...
class Zone(dict):
    def __init__(self, name, front_setback, side_setback, rear_setback, height, stories, far, max_lot_coverage, min_open_space, lot_area, max_dua, lot_frontage, parking_ratio=None):
        self["name"] = name
        ...
        self["district_parking_ratio"] = parking_ratio if parking_ratio is not None else PARKING_MINIMUM
